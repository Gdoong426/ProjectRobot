...
BEGIN_MESSAGE_MAP(CProjectRobotApp, CWinApp)
...
CProjectRobotApp::CProjectRobotApp()
{
	// 支援重新啟動管理員
...
// 僅有的一個 CProjectRobotApp 物件

CProjectRobotApp theApp;


// CProjectRobotApp 初始設定

BOOL CProjectRobotApp::InitInstance()
{
